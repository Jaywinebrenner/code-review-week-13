    ...
    <div className='about-div'>
      ...
      padding-left: 50px;
        ...
        <div className='kens-info-text'>
          <h5>Hi, I'm Ken. Welcome to Ken's Kegs. I weigh 189 pounds and have an infected molar. I once met Michelle Pfiffer and have a mint condiction Optimus Prime still in the box. This is where I plan to tell you about my fantastic Brewery and potentially go track down some lorem epsom. I don't know how to use a chop saw or bake bread.</h5>
        </div>
